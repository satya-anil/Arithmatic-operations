...
public class XID_def implements Xid {
...
public  XID_def(T4Properties t4props, LogicalByteArray buffer1, int index1) {
    ...
    m_t4props = t4props;
    formatID = buffer1.extractInt();
    index1 += 4;
    gtrid_length = buffer1.extractInt();
    index1 += 4;
    bqual_length = buffer1.extractInt();
    index1 += 4;
    data = buffer1.extractByteArray(dataLength());
 ...
 public  XID_def(T4Properties t4props, Xid xid) throws XAException {
    ...
    initializeData();
    System.arraycopy(gtrid, 0, data, 0, gtrid_length);

    System.arraycopy(bqual, 0, data, gtrid_length, bqual_length);

    hashCode = toString().hashCode();
  }
  
  //Newly added for testing the solution 10-150602-6624
  public XID_def(int p_formatId, byte[] p_gtrid, byte[] p_bqual) {
...
//      SQLException {
//    index1 = buffer1.insertInt(index1, formatID);
//    index1 = buffer1.insertInt(index1, gtrid_length);
//    index1 = buffer1.insertInt(index1, bqual_length);
//    index1 = buffer1.insertByteArray(data,dataLength(),0);
//
//    return index1;
//  }
