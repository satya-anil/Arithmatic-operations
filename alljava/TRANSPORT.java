...
class TRANSPORT {
	...
	static final int size_bytes(byte[] buf, boolean fixForServer) {
		return (buf != null && buf.length > 0) ? size_int + buf.length + 1
				: size_int + 1;
	}
	...
	//New API for ExecuteBatch -R3.0
	static final short SRVR_API_EXECUTE_ARRAY = 3042;
	...
	// static final short TYPE_SINGLETON = 0x0800;
