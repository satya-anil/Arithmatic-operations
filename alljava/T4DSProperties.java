 ...
 * <code>T4DSProperties</code> is inherited by the <code>SQLMXDataSource,
...
public class T4DSProperties extends T4Properties {
	...
	/**
	 * Sets the MXCS server data source name. The MXCS server data source is
	 * defined by MXCS on the server.
	 *
	 * @param serverDataSource
	 *            the MXCS data source name to use on the MXCS server side. The
	 ...
	 *
	 * @param catalog
	 *            Nonstop SQLMX Database catalog name. The default catalog name is
	 *            set by the MXCS server-side data source.
	 * @see #getCatalog()
	 */
	 ...
	 *
	 * @param schema
	 *            Nonstop SQLMX Database schema name. The default schema name is
	 *            set by the MXCS server side data source.
	 * @see #getSchema()
	 */
	 ...
	 * driver URL uses the format: <code>jdbc:t4sqlmx://host:port/:</code>
	 *
	 ...
	 * the format: <code>jdbc:t4sqlmx://host:port/:prop-name=value</code>.
	 ...
	 * <code>jdbc:t4sqlmx://host:port/[:][prop-name=value][,prop-name=value]...</code>
	 *
	 * @return the URL string.
	 * @see #setUrl(String)
	 */
	 ...
	 * <PRE>
	 *
	 * OFF (no logging) SEVERE (highest value) WARNING INFO CONFIG FINE FINER
	 * FINEST (lowest value). ALL (log all messages)
	 *
	 * </PRE>
	 *
	 * @param level
	...
	public void setT4QueryExecuteLogFile(String t4QueryExecuteLogFile) {
			super.setT4QueryExecuteLogFile(t4QueryExecuteLogFile);
	}

	public String getT4QueryExecuteLogFile() {
		return super.getT4QueryExecuteLogFile();
	}
	//R3.1 changes -- End
	 ...
	 * <PRE>
	 *
	 * static int ROUND_CEILING Rounding mode to round toward positive infinity.
	 * static int ROUND_DOWN Rounding mode to round toward zero. static int
	 * ROUND_FLOOR Rounding mode to round toward negative infinity. static int
	 * ROUND_HALF_DOWN Rounding mode to round toward &quot;nearest
	 * neighbor&quot; unless both neighbors are equidistant, in which case round
	 * down. static int ROUND_HALF_EVEN Rounding mode to round toward the
	 ...
	 * neighbors are equidistant, in which case round up. static int
	 * ROUND_UNNECESSARY Rounding mode to assert that the requested operation
	 * has an exact result; hence no rounding is necessary. static int ROUND_UP
	...
	//----------------------------------------------------------
	// setter/getter methods for KANJI

	/**
	 * Sets the character set to use when encoding or decoding a Java
	 * String from a SQL/MX data item described with the KANJI
	 * character set.
	 * @param lang A supported java.io character set encoding
	 * @see #getKANJI()
	 */
	public void setKANJI(String lang) {
		super.setKANJI(lang);
	}

	/**
	 * Returns the KANJI character set mapping associated with the current
	 * Type 4 connection.
	 * @return The KANJI character set mapping.
	 * @see #setKANJI(String)
	 */
	public String getKANJI() {
		return super.getKANJI();
	}

	//----------------------------------------------------------
	// setter/getter methods for KSC5601

	/**
	 * Sets the character set to use when encoding or decoding a Java
	 * String from a SQL/MX data item described with the KSC5601
	 * character set.
	 * @param lang A supported java.io character set encoding
	 * @see #getKSC5601()
	 */
	public void setKSC5601(String lang) {
		super.setKSC5601(lang);
	}

	/**
	 * Returns the KSC5601 character set mapping associated with the current
	 * Type 4 connection.
	 * @return The KSC5601 character set mapping.
	 * @see #setKSC5601(String)
	 */
	public String getKSC5601() {
		return super.getKSC5601();
	}
	
	public String getCloseConnectionUponQueryTimeout() {
		return super.getCloseConnectionUponQueryTimeout();
	}


	public void setCloseConnectionUponQueryTimeout(String value) {
		super.setCloseConnectionUponQueryTimeout(value);
	}

  //MFC new property enableMFC R3.0
	public String getEnableMFC() {
	  return super.getEnableMFC();
  }

	public void setEnableMFC(String enableMFC) {
	  super.setEnableMFC(enableMFC);
  }
	//RFE autoCommit changes	
	public String getAutoommit() {
	...
	public void setQueryExecuteTime(long queryExecuteTime) {
		super.setQueryExecuteTime(queryExecuteTime);
	}
	public void setQueryExecuteTime(String queryExecuteTime) {
		super.setQueryExecuteTime(queryExecuteTime);
	}
	public long getQueryExecuteTime() {
		return super.getQueryExecuteTime();
	}
	//R3.1 changes - end
	
	public String getExecuteBatchWithRowsAffected(){
		return super.getExecuteBatchWithRowsAffected();
	}

	public void setExecuteBatchWithRowsAffected(String executeBatchWithRowsAffected) {
		  super.setExecuteBatchWithRowsAffected(executeBatchWithRowsAffected);
	  }
	...
	public void setExternalCallHandler(String externalCallHandler) {
		super.setExternalCallHandler(externalCallHandler);
	}
	...
	public String getExternalCallHandler() {
		return super.getExternalCallHandler();
	}
	...
	public void setExternalCallPrefix(String externalCallPrefix) {
		super.setExternalCallPrefix(externalCallPrefix);
	}
	...
	public String getExternalCallPrefix() {
		return super.getExternalCallPrefix();
	}

	//10-090921-4730

	//Soln 10-100224-8338 -start

	public void setMfuStatementCache(String mfuStatementCache) {
		super.setMfuStatementCache(mfuStatementCache);
	}

	public String getMfuStatementCache() {
		return super.getMfuStatementCache();
	}

	//Soln 10-100224-8338 - End
	
	//Added for commit work RFE
	public String getUseExternalTransaction() {
		return super.getUseExternalTransaction();
	}


	public void setUseExternalTransaction(String useExternalTransaction) {
		super.setUseExternalTransaction(useExternalTransaction);
	}
	
	// Soln 10-120724-4205
	  public String getDbMetaDataforDBTools() {
	      return super.getDbMetaDataforDBTools();
	  }

	  public void setDbMetaDataforDBTools(String value) {
	      super.setDbMetaDataforDBTools(value);
	  }
	  // Added for solution 10-190130-9260
	  public String getCloseConnectionUponStatementCancel() {
		  return super.getCloseConnectionUponStatementCancel();
	  }

	  public void setCloseConnectionUponStatementCancel(String value) {
		  super.setCloseConnectionUponStatementCancel(value);
	  }
